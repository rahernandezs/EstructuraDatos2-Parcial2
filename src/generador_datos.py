...
def generar_productos():
    nombres = ["Laptop", "Mouse", "Teclado", "Monitor", "Silla", "Libro", "Camisa", "Balon"]
    categorias = ["Electronica", "Ropa", "Libros", "Hogar", "Deportes"]

    productos = []

    for i in range(1, 51):  # EXACTAMENTE 50
        ...
        productos.append(
            Producto(i, nombre, precio, categoria, stock, calificacion_promedio)
        )
